...
RequestsManager::Response CommunicationInterface::SendRequest(
...
std::string CommunicationInterface::GetUrl(const std::string& method_name,
                                           cpr::Parameters* params) {
  static const std::string address("https://api.vk.com/method/"),
      version("5.40");
...
void CommunicationInterface::HandleCaptcha(
